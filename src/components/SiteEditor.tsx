...
export default function SiteEditor(){
 ...
 if(!site.canEdit||location.pathname==='/admin')return null;
 if(!editing)return <div className="editor-shortcuts"><button onClick={()=>site.setEditing(true)}>✎ Edit site</button><button onClick={()=>navigate('/admin')}>Workspace</button></div>;
 ...
 return <aside className="site-editor" aria-label="Site editor">
  ...
  {tab==='Text'&&<>
   ...
   <p className="editor-tip">Repeated wording, like the product name, changes everywhere. Payment status messages come from Stripe.</p>
  </>}
  {tab==='Photos'&&<>
